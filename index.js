...
const streamToBlob = (stream, contentType) =>
...
*/
QuickBooks.prototype.upload = async function(filename, contentType, stream, entityType, entityId, callback) {  
var that = this
const formData = new FormData();
formData.set('file_content_01', await streamToBlob(stream, contentType), filename)
var opts = {
 url: '/upload',
 formData
}
...
if (!options.formData) opts.headers['Content-Type'] = 'application/json',
opts.qs.format = 'json';
...
fetch(opts.url, {
 ...
 body: options.formData ? options.formData : opts.body && JSON.stringify(opts.body),
})
